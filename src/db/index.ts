...
database.once('open', () => {
  ...
  //     .keys(participantIDs)
  //     .forEach((id: any) => {
  //       api.getUserInfo(id, (e: any, info: any) => {
  //         console.log(info);

  //         Member.insertMany([new Member({
  //           memberID: id,
  //           name: info[id].name,
  //           firstName: info[id].firstName,
  //           vanity: info[id].vanity,
  //           thumbSrc: info[id].thumbSrc,
  //           profileUrl: info[id].profileUrl,
  //           gender: info[id].gender,
